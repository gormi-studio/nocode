...
export const products = [
  {
    ...
    name: '하이브리드 이동 트레이',
    image: asset('/images/products/scissors-pro.png'),
    imageFallback: asset('/images/product-scissors.svg'),
    contextCopy: '고정형 트레이와 휴대용 정리함의 장점을 결합한 하이브리드 구성입니다. 매장에서는 거치해 쓰고, 출장 시에는 그대로 들고 이동할 수 있습니다.',
    price: 420000,
    rating: 4.9,
    reviewCount: 86,
    level: 'professional',
    ...
    tags: ['이동', '정리함'],
    isFeatured: true,
    recommendSituations: ['매장 거치와 출장 이동을 모두 소화해야 하는 경우', '정리함과 트레이를 각각 사기 부담스러운 경우'],
    exceptSituations: ['한 가지 용도로만 가볍게 쓰고 싶은 경우'],
  },
  {
    id: 2,
    slug: 'beginner-styling-scissors',
    name: '입문자 스타일링가위',
    image: asset('/images/products/scissors-beginner.png'),
    imageFallback: asset('/images/product-scissors.svg'),
  ...
  },
  {
    ...
    name: '와이드 콤 세트',
    image: asset('/images/products/comb-set.png'),
  ...
  },
  {
    ...
    name: '전문가용 커팅 콤',
    image: asset('/images/products/comb-set-pro.png'),
    imageFallback: asset('/images/product-comb.svg'),
  ...
  },
  {
    ...
    name: '라운드 스타일링 브러쉬',
    image: asset('/images/products/brush-round.png'),
  ...
  },
  {
    ...
    name: '살롱 정리 트레이 (기본)',
    image: asset('/images/products/tray-basic.png'),
  ...
  },
  {
    ...
    slug: 'salon-tray-pro',
    name: '살롱 정리 트레이 (프로)',
    image: asset('/images/products/tray-pro.png'),
    imageFallback: asset('/images/product-tray.svg'),
  ...
  },
  {
    ...
    slug: 'mobile-caddy',
    name: '이동식 도구 정리함',
    image: asset('/images/products/caddy-mobile.png'),
