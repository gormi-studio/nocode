...
import { TRAY_CART_RENDER } from '@/data/fixtures';
...
export default function TrayBuilder() {
  ...
  // supplies them; none exist yet, so FallbackImg always resolves to the
  // static tray render below in the meantime.
        ...
        <div className="relative max-w-[1280px] mx-auto px-5 md:px-12 pt-12 pb-10 md:pt-16">
          <Reveal className="max-w-3xl">
            ...
            <h1 className="font-serif-kr text-3xl md:text-5xl font-bold text-black tracking-tight leading-[1.2]">
              소재부터 가위꽂이까지<br />직접 조합해 보세요
            </h1>
            <p className="mt-5 text-[#575757] leading-[1.6]">
              소재 → 색상 → 도구함 → 가위꽂이 순서로 구성하며 실시간 미리보기를 확인합니다.
            </p>
          </Reveal>
        </div>
      </section>
              ...
              <OptionSection n="04" title="가위꽂이">
                ...
                {scissorHolder && (
                  <div className="mt-[22px]">
                    <div>
                      <h4 className="text-[17px] font-bold mb-3.5">밍크털 색상</h4>
